...
public class Menu {
	...
	/**
	 * The show menu method prompts the user for the input
	 * of two files that will be compared.
	 */
	// shows the menu
	public void show() {
	...
	/**
	 * The validFile method checks to see if the file given can
	 * be opened, and if it can it returns true, else false.
	 * @param fileName String
	 * @return boolean, true if file ok
	 */
